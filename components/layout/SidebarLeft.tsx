...
const SidebarLeft: React.FC = () => {
  ...
  return (
    <aside className="hidden lg:block w-64 pb-20 overflow-y-auto border-r border-gray-200 bg-white no-scrollbar sticky top-14 h-[calc(100vh-3.5rem)]">
      ...
      <div className="px-4 py-2">
        <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Environmental Action</h3>
        <div className="space-y-1">
            <NavItem 
            to="/app/campaigns" 
      ...
      <div className="px-4 py-2">
        <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Gamification</h3>
        <div className="space-y-1">
            <NavItem 
            to="/app/leaderboard" 
            label="Leaderboard" 
      ...
      <div className="px-4 py-2">
        <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Innovation & Learning</h3>
        <div className="space-y-1">
            <NavItem 
            to="/app/innovation" 
