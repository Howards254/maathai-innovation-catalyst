...
('Plant a Tree Today', 'Plant at least 1 tree in any campaign', 1, 20, CURRENT_DATE),
('Community Engagement', 'Comment on 3 discussions', 3, 15, CURRENT_DATE),
('Event Participation', 'RSVP to an environmental event', 1, 25, CURRENT_DATE);