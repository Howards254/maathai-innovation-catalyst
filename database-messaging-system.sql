...
-- 9. Function to update conversation timestamp
...
-- 10. Trigger to update conversation on new message
...
-- 11. Function to get or create direct conversation
...
-- 12. Add unread count column to conversation_participants
DO $$ 
BEGIN
